...
\newcommand*{\hysheader}{\begingroup
  ...
  \setlength{\leftcol}{40mm}
  \setlength{\rightcol}{\headingwidth}
  \addtolength{\rightcol}{-\leftcol}
  \noindent
  \begin{tabular}{>{\columncolor[gray]{0.90}}p{\leftcol}>{\columncolor[gray]{0.90}}p{.95\rightcol}}
  \quad & \quad \\
   & {\sffamily\bfseries\large\noindent\hfill III CONVEGNO ITALIANO SUI CHIROTTERI\quad} \\
   & {\sffamily\hfill Trento, 9-11 ottobre 2015\quad} \\
   & \quad \\
   \multirow{-4}{*}[5mm]{\includegraphics[height=20mm]{logotipo_girc_300dpi_10cm.png}}  & {\hfill\footnotesize Edited and published by Gruppo Italiano Ricerca Chirotteri -- Associazione Teriologica Italiana\quad} \\
  \end{tabular}\par
  \vspace{5mm}
  \endgroup}
...
\newcommand*{\hysfooter}{\begingroup
   ...
   %\footnotesize\noindent\includegraphics[height=.9\baselineskip]{logo-doaj_gray.png}{\quad This Journal adheres to the Open Access initiative and is listed in the Directory of Open Access Journals (\url{www.doaj.org}).}
  \endgroup}
...
\newcommand*{\hysguardeditor}[1]{
  \def\hysguardeditor{A cura di\\{#1}}
}
...
\newcommand*{\hysfrontcover}{\begingroup
  ...
  \vspace{60mm}
  \flushright
  \begin{tabular}{p{30mm}p{83mm}}
    \multirow{3}{*}[8mm]{\includegraphics[height=30mm]{ATIt_300dpi.png}}
...
\newcommand*{\hysfrontendpaper}{\begingroup
  ...
  \noindent\textbf{Comitato Organizzatore}\\
  {\hysLarge Leonardo~\textsc{Ancillotto}}\\
  {\hysLarge Marco~\textsc{Ciolli}} \\
  {\hysLarge Gaetano~\textsc{Fichera}}\\
  {\hysLarge Giacomo~\textsc{Maltagliati}}\\
  {\hysLarge Stefania~\textsc{Mazzaracca}}\\
  {\hysLarge Mauro~\textsc{Mucedda}}\\
  {\hysLarge Pamela~\textsc{Priori}}\\
  {\hysLarge Marco~\textsc{Riccucci}}\\
  {\hysLarge Federica~\textsc{Roscioni}}\\
  {\hysLarge Martina~\textsc{Spada}}\\
  {\hysLarge Liana~\textsc{Trentin}}\\
  \par\vspace{\hysspacer}
  \noindent\textbf{Comitato Scientifico}\\
  {\hysLarge Paolo~\textsc{Agnelli}}\\
  {\hysLarge Leonardo~\textsc{Ancillotto}}\\
  {\hysLarge Marco~\textsc{Ciolli}} \\
  {\hysLarge Giacomo~\textsc{Maltagliati}}\\
  {\hysLarge Mauro~\textsc{Mucedda}}\\
  {\hysLarge Damiano~\textsc{Preatoni}}\\    
  {\hysLarge Marco~\textsc{Riccucci}}\\\\
  {\hysLarge Federica~\textsc{Roscioni}}\\
  {\hysLarge Danilo~\textsc{Russo}}\\  
  {\hysLarge Dino~\textsc{Scaravelli}}\\
  {\hysLarge Martina~\textsc{Spada}}\\
  \par\vspace{\hysspacer}
  \noindent\textbf{Segreteria Organizzativa}\\
  {\hysLarge Myriam~\textsc{Stettermayer}}
  \par\vspace{\hysspacer}
  \par%\vspace{\hysspacer}
  \vfill
  \begin{footnotesize}
...
\newcommand*{\hysguardpage}{\begingroup % Hystrix front page
  ...
  \begin{tcolorbox}[size=tight,oversize,
    ...
    \begin{tabular}{p{110mm}p{40mm}}
      ...
      & \\
      & \\
      \fontsize{30}{30}\selectfont\textcolor{white}{\textbf{III CONVEGNO ITALIANO}} & \\ [2mm]
      \fontsize{30}{30}\selectfont\textcolor{white}{\textbf{SUI CHIROTTERI}} & \\ [3mm]
      \huge\textcolor{white}{Trento, 9-11 ottobre 2015} & \\
      & \\
    \end{tabular}
  \end{tcolorbox}
  \ifx{\hysguardtitle}% is there any issue title to typeset?
      \relax          % no, go on
    \else             % yes, typeset it
      {\parbox[t]{\textwidth}{
         \vspace{20mm}\centering\rmfamily\bfseries\Huge\hysguardtitle}}\fi  
         
  \ifx{\hysguardeditor}% is there any issue editor name to typeset?
      \relax          % no, go on
    \else             % yes, typeset it
      {\parbox[t]{\textwidth}{
         \vspace{2mm}\centering\rmfamily\Large\hysguardeditor}}\fi  
  \vfill
  \hfill
  \parbox[t]{.5\textwidth}{
    \flushright
    {\noindent\sffamily\large published by}\\
    {\noindent\sffamily\Large Gruppo Italiano Ricerca Chirotteri\\\noindent\sffamily\Large Associazione Teriologica Italiana}
    }
  \endgroup}
...
\newcommand*{\hysfrontpage}{\begingroup % The issue title page
  ...
  \vfill
  \centering
  {\noindent\HUGE\bfseries{III Congresso Italiano sui Chirotteri}}\\
  \medskip
  {\noindent\LARGE Trento, 9~-~11 ottobre 2015}\\
  \bigskip
  ...
  {\noindent\LARGE Gruppo Italiano Ricerca Chirotteri -- Associazione Teriologica Italiana}\par
  {\noindent\LARGE Universita degli Studi di Trento,\\Dipartimento di Ingegneria Civile, Ambientale e Meccanica}\par\par
  \bigskip
  ...
  \begin{tabular}{*{3}{p{.33\textwidth}}}
    \centering \includegraphics[height=2.5cm]{logo_DICAM_web_1.jpg} &
    \centering \includegraphics[height=2.5cm]{Logo_ATIt_ritaglio.png} &
    \centering \includegraphics[height=2.5cm]{logotipo_girc_300dpi_10cm.png} \\
  \end{tabular}
  \end{table}
    {\noindent\LARGE\textsc{Con il patrocinio di}}\\[\baselineskip]
    \centering \includegraphics[height=2.5cm]{ISPRA_CENTRATO_colore.png}
  \end{center}\par
  \vskip3mm
  \begin{tcolorbox}[size=tight,oversize,
      sharp corners,
      ...
      top=10pt,
      fontupper=\small]
    \center\selectfont\textcolor{white}{Sponsored by}\\
    \includegraphics[width=60mm]{Logo_Pettersson_h_ed2_www2_20.png}
  \end{tcolorbox}
